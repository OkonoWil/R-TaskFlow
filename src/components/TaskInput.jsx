export const TaskInput = () => {
    ...
    return (
        <div className="w-full mt-5 bg-gray-700 p-4 rounded-lg border-gray-600 bg-opacity-25 border-[1px]">
            ...
            <form className="flex flex-row justify-between my-2">
                ...
                <button type="submit" className="p-2 bg-blue-800 bg-opacity-20 text-blue-600 font-semibold w-28 ml-5 border rounded-md border-blue-700">Ajouter</button> 
            </form>
        </div>
    );
}